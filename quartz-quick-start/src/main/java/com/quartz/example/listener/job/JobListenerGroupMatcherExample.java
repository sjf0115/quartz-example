...
/**
 * 功能：注册局部作业监听器 GroupMatcher 示例
 * 作者：@SmartSi
 * 博客：https://smartsi.blog.csdn.net/
 * 公众号：大数据生态
 * 日期：2025/12/7 08:40
 */
public class JobListenerGroupMatcherExample {
    private static final Logger LOG = LoggerFactory.getLogger(JobListenerGroupMatcherExample.class);
