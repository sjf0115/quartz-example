...
/**
 * 功能：dailyAtHourAndMinute 示例
 * 作者：@SmartSi
 * 博客：https://smartsi.blog.csdn.net/
 * 公众号：大数据生态
 * 日期：2025/12/13 13:49
 */
public class DailyAtHourAndMinuteExample {
    private static final Logger LOG = LoggerFactory.getLogger(DailyAtHourAndMinuteExample.class);
