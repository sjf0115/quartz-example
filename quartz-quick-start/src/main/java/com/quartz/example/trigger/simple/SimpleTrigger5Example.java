 ...
 * 日期：2025/12/7 23:15
 */
public class SimpleTrigger5Example {
    private static final Logger LOG = LoggerFactory.getLogger(SimpleTrigger5Example.class);
    ...
    public static void main(String[] args) throws Exception {
        ...
        // 4. 将任务和触发器注册到调度器
        scheduler.scheduleJob(jobDetail, trigger5);
